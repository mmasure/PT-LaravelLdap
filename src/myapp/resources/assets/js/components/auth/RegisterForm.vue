    ...
    <form method="post" @submit.prevent="submit" @keydown="clearErrors($event.target.name)">
        ...
        <div class="form-group has-feedback " :class="{ 'has-error': form.errors.has('username') }">
            <input type="text" class="form-control" placeholder="Login" name="username"
                   value="" v-model="form.username" autofocus/>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
            <transition name="fade">
        ...
        <div class="row">
            ...
            <div class="col-xs-4 col-xs-push-1">
                <button type="submit" class="btn btn-primary btn-block btn-flat btn-submit" :disabled="form.errors.any()"
                        v-text="trans('adminlte_lang_message.register')">
...
export default {
    ...
    data: function () {
        return {
            form: new Form({name: '', username: '', email: '', password: '', password_confirmation: '', terms: ''})
        }
    },
    watch: {
